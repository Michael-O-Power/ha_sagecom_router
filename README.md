# \# ha\_sagemcom\_router

# 

# !\[Home Assistant](https://img.shields.io/badge/Home\_Assistant-Custom\_Component-blue?logo=home-assistant)
...
# 3\. Paste this repository URL into the text box: `https://github.com/Michael-O-Power/ha\_sagemcom\_router`
...
# 3\. If you don't already have a `custom\_components` folder, create one:

# &#x20;  ```bash

# &#x20;  mkdir custom\_components
